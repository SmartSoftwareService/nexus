    ...
    "
        ...
        <div
          ...
          style={{
            ...
            height: "500px",
            filter: "blur(40px)",
            clipPath: "polygon(0% 0%,8% 0%,8% 30%,20% 0%,28% 0%,28% 100%,20% 100%,20% 70%,8% 100%,0% 100%,0% 0%,32% 0%,48% 0%,48% 12%,40% 12%,40% 40%,46% 40%,46% 52%,40% 52%,40% 88%,48% 88%,48% 100%,32% 100%,32% 0%,52% 0%,60% 0%,68% 20%,76% 0%,84% 0%,72% 40%,84% 70%,76% 70%,68% 50%,60% 70%,52% 70%,64% 40%,52% 0%,88% 0%,96% 0%,96% 100%,88% 100%,88% 0%,100% 0%,100% 100%,92% 100%,92% 0%)"          }}
        >
